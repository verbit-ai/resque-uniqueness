      ...
      module ClassMethods
        def remove_queue(queue)
          ...
          Resque.redis.multi do
            res = super
            Resque::Uniqueness.remove_queue(queue)
          end
          res
        end
        ...
        def remove_delayed_job(encoded_item)
          ...
          res = super
          Resque::Uniqueness.unlock_schedule(nil, decode(encoded_item))
          res
        end
        ...
        def remove_delayed_job_from_timestamp(timestamp, klass, *args)
          ...
          Resque::Uniqueness.unlock_schedule(nil, 'class' => klass.to_s, 'args' => args)
          removed_count
        end
      end
    end
